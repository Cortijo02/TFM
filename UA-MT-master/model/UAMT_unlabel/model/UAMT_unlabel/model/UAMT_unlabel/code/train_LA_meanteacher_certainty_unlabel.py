...
from dataloaders.la_heart import RandomCrop, CenterCrop, RandomRotFlip, ToTensor, TwoStreamBatchSampler, LAHeart 


parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str, default='../data/2018LA_Seg_Training Set/', help='Name of Experiment')
parser.add_argument('--exp', type=str,  default='UAMT_unlabel', help='model_name')
parser.add_argument('--max_iterations', type=int,  default=25, help='maximum epoch number to train')
